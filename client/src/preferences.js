    ...
    return (
      <div style={{ marginBottom: 24 }} key={index}>
        {section?.name && section.name==="DoodleDocs" &&(
          <div
          style={{
            backgroundColor: "rgba(200, 216, 230, 0.6)", // Purple tint with alpha
            paddingTop: 12,
            paddingBottom: 12,
            marginBottom: 18,
...
function ChannelLevelPreferences({ preferenceData, setPreferenceData }) {
  return (
    <div>
     <div
          style={{
            backgroundColor: "rgba(200, 216, 230, 0.6)", 
            paddingTop: 12,
            paddingBottom: 12,
            marginBottom: 18,
            borderRadius: 10, // Rounded corners
...
export default function Preferences() {
  ...
  return (
<div style={{ margin: "7% 15%", backgroundColor: 'rgba(243, 242, 243, 0.9)', padding: '20px', borderRadius: '10px' }}>
